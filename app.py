...
st.set_page_config(page_title="Smart Hospital Triage", page_icon="🏥", layout="centered")
...
if st.button("🚀 Process Patient Triage", type="primary", use_container_width=True):
    ...
    dur_encoded = {'Less than 1 day': 0, '1-3 days': 1, '4-7 days': 2, 'More than 1 week': 3, 'Unknown': 4}[duration]
    ...
    new_patient = pd.DataFrame([{
        ...
        'nausea_vomiting': nausea_vomiting, 'dizziness': dizziness, 'skin_rash': skin_rash,
        'temperature_level': temp_encoded, 'heart_rate_level': hr_encoded, 'duration': dur_encoded,
